...
export const DICT: Dict = {
  ...
  'source.offline':          { en: 'Offline', fr: 'Hors ligne', ar: 'دون اتصال' },
  'source.offline.detail':   {
    en: 'Times computed locally — online verification unavailable right now.',
    fr: 'Horaires calculés localement — la vérification en ligne est indisponible.',
    ar: 'يتم حساب الأوقات محليًا — التحقق عبر الإنترنت غير متاح حاليًا.',
  },
